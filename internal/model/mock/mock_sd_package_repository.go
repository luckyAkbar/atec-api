...
// GetTemplateByPackageID mocks base method.
func (m *MockSDPackageRepository) GetTemplateByPackageID(arg0 context.Context, arg1 uuid.UUID) (*model.SpeechDelayTemplate, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTemplateByPackageID", arg0, arg1)
	ret0, _ := ret[0].(*model.SpeechDelayTemplate)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTemplateByPackageID indicates an expected call of GetTemplateByPackageID.
func (mr *MockSDPackageRepositoryMockRecorder) GetTemplateByPackageID(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTemplateByPackageID", reflect.TypeOf((*MockSDPackageRepository)(nil).GetTemplateByPackageID), arg0, arg1)
}
